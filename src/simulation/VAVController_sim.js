 ...
 *
 * Models a VAV (Variable Air Volume) terminal box downstream of AHU-4-4,
 * following the same formula-driven pattern as AHU44NewController.js. One
 * zone is modeled, served by AHU-4-4 (Ballroom Level 2):
 *   - VAV-4-4-02 — Ballroom
...
(function() {
  ...
  var ZONES = [
    { id: 'VAV-4-4-02', label: 'Conference Room', servedBy: 'AHU-4-4' }
  ];
